    ...
    with conn:
        cursor.execute(f"""INSERT INTO trials 
                        ...
                        ( '{trial['trial_id']}',
                          {trial['search_id']}, 
                          '{trial['model_path']}', 
                          {trial['average_fraction_of_heart_in_mri_batch']}, 
                          {trial['average_fraction_of_pos_gradients_in_heart_in_batch_of_mris']}, 
                          {trial['average_fraction_of_neg_gradients_in_heart_in_batch_of_mris']}
                        )
                        ON CONFLICT DO NOTHING
                      """)
    conn.close()
