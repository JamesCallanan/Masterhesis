let interval = setInterval( () => {
    ...
    if (document.getElementById('cell-ymS1xOaTctRH').classList.contains('code-has-output')) { //Checking to see if HTMLCollection array returned has any elements in it
